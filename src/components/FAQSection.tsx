...
export default function FAQSection() {
  ...
  return (
    <div id="faq" className="w-full bg-white py-32 border-b border-[#edeaea] relative overflow-hidden">
      
      {/* Light Radial Luxury Ambient Details */}
      <div className="absolute right-[-10%] top-1/4 h-96 w-96 rounded-full bg-amber-400/[0.015] filter blur-[100px] pointer-events-none" />
      <div className="absolute left-[-5%] bottom-10 h-80 w-80 rounded-full bg-neutral-900/[0.01] filter blur-[100px] pointer-events-none" />
            ...
            <div className="p-7 rounded-[2rem] bg-neutral-50 border border-neutral-200/80 relative overflow-hidden group">
              ...
              <div className="space-y-2.5 pt-4 border-t border-neutral-200/60">
                <a 
                  ...
                  className="flex items-center gap-2.5 text-xs text-neutral-700 hover:text-amber-700 font-bold transition-colors"
                >
              ...
              return (
                <div
                  ...
                  className={`rounded-2xl border transition-all duration-300 overflow-hidden ${
                    isOpen 
                      ? 'bg-neutral-50/70 border-neutral-900/40 shadow-md' 
                      : 'bg-white border-neutral-200 hover:border-neutral-900/30'
                  }`}
                >
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <span className={`text-xs font-mono font-black ${isOpen ? 'text-amber-650' : 'text-neutral-400'}`}>
                    ...
                    <div className={`p-1.5 rounded-lg border transition-all duration-300 shrink-0 ${
                      isOpen ? 'bg-neutral-950 text-white border-neutral-950 rotate-180' : 'bg-neutral-50 text-neutral-500 border-neutral-200'
                    }`}>
